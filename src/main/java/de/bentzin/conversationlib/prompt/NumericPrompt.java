...
public abstract class NumericPrompt extends ValidatingPrompt {
    ...
    protected boolean isInputValid(@NotNull ConversationContext context, @NotNull String input) {
        return NumberUtils.isCreatable(input) && isNumberValid(context, NumberUtils.createNumber(input));
    }

    /**
     * Override this method to do further validation on the numeric
    ...
    /**
     * Override this method to perform some action with the user's number
     * response.
     *
     * @param context Context information about the conversation.
    ...
    @Nullable
    @Override
    protected Component getFailedValidationText(@NotNull ConversationContext context, @NotNull String invalidInput) {
     ...
     */
    @Nullable
    protected Component getInputNotNumericText(@NotNull ConversationContext context, @NotNull String invalidInput) {
        return null;
    }
     ...
     */
    @Nullable
    protected Component getFailedValidationText(@NotNull ConversationContext context, @NotNull Number invalidInput) {
        return null;
    }
}